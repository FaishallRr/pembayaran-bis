  ...
  <div class="flex justify-center items-center min-h-screen mt-[-180px]">
    <div class="max-w-lg w-full bg-white shadow-lg rounded-lg p-8">
      <div class="flex items-center justify-between mb-6">
        <img src="../../img/bni.png" alt="DANA Logo" class="w-20 h-15" />
        <h2 class="text-2xl font-bold text-[#2563eb]" data-lang="pembayaranViaBank">
          Pembayaran via BANK BNI
        </h2>
      </div>
      <!-- Countdown Timer -->
  ...
  <script>
    const languageData = {
      en: {
        ...
        pembayaranViaBank: "Payment via BANK BNI",
        instruksiPembayaran1: "1. Open the BANK BNI app on your smartphone.",
      ...
      id: {
        ...
        pembayaranViaBank: "Pembayaran via BANK BNI",
        instruksiPembayaran1: "1. Buka aplikasi BANK BNI di smartphone Anda.",
        instruksiPembayaran2: "2. Pilih menu 'Transfer'.",
        instruksiPembayaran3: "3. Masukkan nomor rekening BANK BNI tujuan:",
