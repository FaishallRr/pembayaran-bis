  ...
  <div class="flex justify-center items-center min-h-screen mt-[-180px]">
    <div class="max-w-lg w-full bg-white shadow-lg rounded-lg p-8">
      <div class="flex items-center justify-between mb-6">
        <img src="../../img/dana.png" alt="DANA Logo" class="w-20 h-15" />
      ...
      <div class="bg-[#f0f8ff] p-6 rounded-lg shadow-md mb-6">
        ...
        <p class="text-gray-700 mb-2" data-lang="instruksiPembayaran3">
          3. Masukkan nomor rekening DANA tujuan:
        </p>
  ...
  <script>
    const languageData = {
      en: {
        ...
        pembayaranViaBank: "Payment via DANA",
        instruksiPembayaran1: "1. Open the DANA app on your smartphone.",
      ...
      id: {
        ...
        pembayaranViaBank: "Pembayaran via DANA",
        instruksiPembayaran1: "1. Buka aplikasi DANA di smartphone Anda.",
        instruksiPembayaran2: "2. Pilih menu 'Transfer'.",
        instruksiPembayaran3: "3. Masukkan nomor rekening DANA tujuan:",
