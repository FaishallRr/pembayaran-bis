  ...
  <div class="flex justify-center items-center min-h-screen mt-[-180px]">
    <div class="max-w-lg w-full bg-white shadow-lg rounded-lg p-8">
      <div class="flex items-center justify-between mb-6">
        <img src="../../img/jateng.png" alt="DANA Logo" class="w-20 h-15" />
  ...
  <script>
    const languageData = {
      en: {
        ...
        pembayaranViaBank: "Payment via BANK JATENG",
        instruksiPembayaran1:
          "1. Open the BANK JATENG app on your smartphone.",
      ...
      id: {
        ...
        pembayaranViaBank: "Pembayaran via BANK JATENG",
        instruksiPembayaran1:
          "1. Buka aplikasi BANK JATENG di smartphone Anda.",
