...
`;
  ...
  <div class="flex justify-center items-center min-h-screen mt-[-100px]">
    <div class="max-w-lg w-full bg-white shadow-lg rounded-lg p-8">
      <div class="flex items-center justify-between mb-6">
        <img src="../../img/qris.png" alt="DANA Logo" class="w-20 h-15" />
      ...
      <div class="flex justify-center items-center mt-3 mb-3">
        <img src="../../img/QR code.jpg" class="w-[250px]" alt="kode qr" />
      </div>
  ...
  <script>
    const languageData = {
      en: {
        ...
        pembayaranViaBank: "Payment via QRIS",
        instruksiPembayaran1: "1. Open the QRIS app on your smartphone.",
        instruksiPembayaran2: "2. Scan the QRIS code.",
        instruksiPembayaran3:
          "3. Enter the amount according to the total payment.",
        instruksiPembayaran4:
          "4. Follow the instructions until the transaction is successful.",
      },
      id: {
        ...
        pembayaranViaBank: "Pembayaran via QRIS",
        instruksiPembayaran1: "1. Buka aplikasi QRIS di smartphone Anda.",
        instruksiPembayaran2: "2. Scan kode QRIS.",
        instruksiPembayaran3:
          "3. Masukkan jumlah sesuai dengan total pembayaran.",
        instruksiPembayaran4: "4. Ikuti petunjuk hingga transaksi berhasil.",
      },
    };
